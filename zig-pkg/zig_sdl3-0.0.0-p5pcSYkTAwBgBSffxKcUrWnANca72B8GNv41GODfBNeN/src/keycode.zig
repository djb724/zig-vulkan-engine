...
pub const Keycode = enum(u32) {
    ...
    rhyper = 0x20000007,
    _,
    pub fn toInt(self: Keycode) u32 {
        return @intFromEnum(self);
    }
    pub fn fromScancode(scancode: scancode_.Scancode) Keycode {
        return @enumFromInt(@as(u32, @intCast(@intFromEnum(scancode))) | SCANCODE_MASK);
    }
};
